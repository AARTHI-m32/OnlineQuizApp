...
const EasyPage = () => {
    ...
    const [result, setResult] = useState(null); // Add useState for result
    ...
    const fetchQuestions = async () => {
        try {
            const response = await fetch("https://questions-api-5.onrender.com/req-questions?difficulty=easy");
            if (!response.ok) {
